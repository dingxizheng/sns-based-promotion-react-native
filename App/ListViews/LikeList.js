...
* @Last Modified time: 2016-03-01 13:31:45
*/
...
var LikeList = React.createClass({
    ...
    _renderRow: function(rowData) {
        return <UserSmallCard user={new User(rowData)} style={{marginTop: 0, marginBottom: 8}}/>  
    },

    _loadData: function(endrefreshing) {
    	this.props.liked.likers({
    		query: Object.assign({}, this.state.initialQuery, this.state.customQuery),
    		headers: { page: 1, per_page: this.per_page, sortBy: this.sortBy}
    	})
    	.then((list) => {
            this.setState({ 
                dataList: list,
